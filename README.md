# node-@dramaorg/pariatur-suscipit [![NPM version][npm-img]][npm-url]
...
When `@dramaorg/pariatur-suscipit.replace()` is used with a replacer function, the replacer can return a buffer, or a string. But all arguments
